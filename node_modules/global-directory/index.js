...
const getEnvNpmPrefix = () =>
  Object.keys(process.env).reduce(
    (prefix, name) =>
      /^npm_config_prefix$/i.test(name) ? process.env[name] : prefix,
    undefined,
  );
...
globalDirectory.npm.packages = path.join(
  npmPrefix,
  isWindows ? "node_modules" : "lib/node_modules",
);
globalDirectory.npm.binaries = isWindows
  ? npmPrefix
...
globalDirectory.yarn.packages = path.join(
  yarnPrefix,
  getYarnWindowsDirectory()
    ? "Data/global/node_modules"
    : "global/node_modules",
);
globalDirectory.yarn.binaries = path.join(
