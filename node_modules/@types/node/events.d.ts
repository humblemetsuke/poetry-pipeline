...
declare module "node:events" {
  ...
  namespace EventEmitter {
    ...
    function setMaxListeners(
      n: number,
      ...eventTargets: ReadonlyArray<EventEmitter | EventTarget>
    ): void;
    /**
    ...
    interface InternalEventEmitter<T extends EventMap<T>> extends EventEmitter {
      ...
      listenerCount<E extends keyof T>(
        eventName: E,
        listener?: (...args: T[E]) => void,
      ): number;
      listenerCount(
      ...
      rawListeners<E extends keyof T>(
        eventName: E,
      ): ((...args: T[E]) => void)[];
    ...
    interface EventEmitterAsyncResourceOptions
      extends AsyncResourceOptions, EventEmitterOptions {
      /**
