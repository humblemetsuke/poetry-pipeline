...
declare module "node:vm" {
  ...
  interface RunningCodeOptions
    extends RunningScriptOptions, Pick<ScriptOptions, "cachedData"> {
    /**
     * Used to specify how the modules should be loaded during the evaluation of this script when `import()` is called. This option is
     * part of the experimental modules API. We do not recommend using it in a production environment. For detailed information, see
     * [Support of dynamic `import()` in compilation APIs](https://nodejs.org/docs/latest-v25.x/api/vm.html#support-of-dynamic-import-in-compilation-apis).
  ...
  function compileFunction(
    ...
    Pick<Script, "cachedData" | "cachedDataProduced" | "cachedDataRejected">;
  /**
  ...
  interface ModuleEvaluateOptions extends Pick<
    RunningScriptOptions,
    "breakOnSigint" | "timeout"
  > {}
  type ModuleLinker = (
    specifier: string,
  ...
  interface SourceTextModuleOptions extends Pick<
    ScriptOptions,
    "cachedData" | "columnOffset" | "lineOffset"
  > {
    /**
