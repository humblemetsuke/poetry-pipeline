...
declare module "node:crypto" {
  ...
  interface PublicKeyExportOptions<
    T extends PublicKeyExportType = PublicKeyExportType,
  > {
    type: T;
  ...
  type KeyExportResult<T, Default> = T extends {
    format: infer F extends KeyFormat;
  }
  ...
  interface ECKeyPairOptions extends KeyPairExportOptions<
    "spki",
    "pkcs8" | "sec1"
  > {
    /**
  ...
  interface ED25519KeyPairOptions extends KeyPairExportOptions<
    "spki",
    "pkcs8"
  > {}
  ...
  interface RSAKeyPairOptions extends KeyPairExportOptions<
    "pkcs1" | "spki",
    "pkcs1" | "pkcs8"
  > {
    /**
  ...
  interface SLHDSAKeyPairOptions extends KeyPairExportOptions<
    "spki",
    "pkcs8"
  > {}
  interface X25519KeyPairOptions extends KeyPairExportOptions<
    "spki",
    "pkcs8"
  > {}
  ...
  function getRandomValues<
    T extends Exclude<
      ...
      | NodeJS.NonSharedFloat16Array
      | NodeJS.NonSharedFloat32Array
      | NodeJS.NonSharedFloat64Array
    >,
  >(typedArray: T): T;
