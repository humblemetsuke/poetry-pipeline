...
declare module "node:http" {
  ...
  > {
    ...
    shouldUpgradeCallback?:
      | ((request: InstanceType<Request>) => boolean)
      | undefined;
    /**
    ...
    extends stream.Writable
  {
    ...
    emit<E extends keyof OutgoingMessageEventMap>(
      eventName: E,
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof OutgoingMessageEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  class ClientRequest extends OutgoingMessage {
    ...
    emit<E extends keyof ClientRequestEventMap>(
      eventName: E,
      ...args: ClientRequestEventMap[E]
    ): boolean;
    emit(eventName: string | symbol, ...args: any[]): boolean;
    ...
    listeners<E extends keyof ClientRequestEventMap>(
      eventName: E,
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof ClientRequestEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  class IncomingMessage extends stream.Readable {
    ...
    emit<E extends keyof IncomingMessageEventMap>(
      eventName: E,
      ...args: IncomingMessageEventMap[E]
    ): boolean;
    emit(eventName: string | symbol, ...args: any[]): boolean;
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof IncomingMessageEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
