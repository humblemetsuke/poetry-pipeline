...
declare module "node:stream" {
  ...
  namespace Stream {
    ...
    interface StreamOptions<T extends Stream> extends Abortable {
      ...
      construct?:
        | ((this: T, callback: (error?: Error | null) => void) => void)
        | undefined;
      destroy?:
        | ((
            this: T,
    ...
    class Readable extends Stream implements NodeJS.ReadableStream {
       ...
       */
      static isDisturbed(
        stream: NodeJS.ReadableStream | web.ReadableStream,
      ): boolean;
      /**
    ...
    class Duplex extends Stream implements NodeJS.ReadWriteStream {
       ...
       */
      static toWeb(
        streamDuplex: NodeJS.ReadWriteStream,
      ): web.ReadableWritablePair;
      /**
    ...
    type PipelineSourceFunction<O> = (
      options?: Abortable,
    ) => Iterable<O> | AsyncIterable<O>;
    ...
    type PipelineSourceArgument<T> = (
      T extends (...args: any[]) => infer R ? R : T
    ) extends infer S
      ? S extends web.TransformStream<any, infer O>
        ? web.ReadableStream<O>
        : S
      : never;
    type PipelineTransformGenerator<
    ...
    type PipelineTransform<
      ...
      O,
    > = S extends
      | PipelineSource<infer I>
      | PipelineTransformStreams<any, infer I>
      | ((...args: any[]) => infer I)
      ? PipelineTransformStreams<I, O> | PipelineTransformGenerator<S, O>
      : never;
    type PipelineTransformSource<O> =
      | PipelineSource<O>
      | PipelineTransform<any, O>;
    type PipelineDestinationFunction<
      S extends PipelineTransformSource<any>,
      R,
    > = (source: PipelineSourceArgument<S>, options?: Abortable) => R;
    type PipelineDestination<
      S extends PipelineTransformSource<any>,
      R,
    > = S extends PipelineSource<infer I> | PipelineTransform<any, infer I>
      ?
          | NodeJS.WritableStream
    ...
    type PipelineResult<S extends PipelineDestination<any, any>> =
      S extends NodeJS.WritableStream ? S : Duplex;
    /**
    ...
    function pipeline<
      ...
      D extends PipelineDestination<S, any>,
    >(
      source: S,
      destination: D,
    ...
    type ComposeSource<O> =
      ...
      | AsyncIterable<O>
      | (() => AsyncIterable<O>);
    type ComposeTransformStreams<I, O> =
      | NodeJS.ReadWriteStream
      | web.TransformStream<I, O>;
    type ComposeTransformGenerator<I, O> = (
      source: AsyncIterable<I>,
    ) => AsyncIterable<O>;
    type ComposeTransform<S extends ComposeTransformSource<any>, O> = S extends
      | ComposeSource<infer I>
      | ComposeTransformStreams<any, infer I>
      | ComposeTransformGenerator<any, infer I>
      ? ComposeTransformStreams<I, O> | ComposeTransformGenerator<I, O>
      : never;
    type ComposeTransformSource<O> =
      | ComposeSource<O>
      | ComposeTransform<any, O>;
    type ComposeDestination<S extends ComposeTransformSource<any>> =
      S extends ComposeTransformSource<infer I>
        ?
            | NodeJS.WritableStream
            | web.WritableStream<I>
            | web.TransformStream<I, any>
     ...
     */
    function isWritable(
      stream: NodeJS.WritableStream | web.WritableStream,
    ): boolean | null;
  }
  global {
    namespace NodeJS {
