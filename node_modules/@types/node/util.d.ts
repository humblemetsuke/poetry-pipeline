...
declare module "node:util" {
  ...
  export type InspectStyle =
    ...
    | "regexp"
    | "module";
  export interface InspectStyles extends Record<
    InspectStyle,
  ...
  export type InspectColorForeground =
    ...
    | "cyanBright"
    | "whiteBright";
  export type InspectColorBackground =
    `bg${Capitalize<InspectColorForeground>}`;
  export type InspectColor =
    | InspectColorModifier
    | InspectColorForeground
    | InspectColorBackground;
  export interface InspectColors extends Record<
    InspectColor,
    [number, number]
  > {}
  ...
  export interface TextDecoder extends TextDecoderCommon {
    decode(
      input?: NodeJS.AllowSharedBufferSource,
