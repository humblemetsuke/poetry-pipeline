  ...
  global {
    ...
    namespace NodeJS {
      ...
      type BeforeExitListener = (
        ...args: ProcessEventMap["beforeExit"]
      ) => void;
      /**
       * @deprecated Global listener types will be removed in a future version.
       * Callbacks passed directly to `process`'s EventEmitter methods
      ...
      type DisconnectListener = (
        ...args: ProcessEventMap["disconnect"]
      ) => void;
      /**
       * @deprecated Global listener types will be removed in a future version.
       * Callbacks passed directly to `process`'s EventEmitter methods
      ...
      type RejectionHandledListener = (
        ...args: ProcessEventMap["rejectionHandled"]
      ) => void;
      /**
       * @deprecated Global listener types will be removed in a future version.
       * Callbacks passed directly to `process`'s EventEmitter methods
      ...
      type UncaughtExceptionListener = (
        ...args: ProcessEventMap["uncaughtException"]
      ) => void;
      /**
       * @deprecated Global listener types will be removed in a future version.
       * Callbacks passed directly to `process`'s EventEmitter methods
      ...
      interface Process extends EventEmitter {
        ...
        emit<E extends keyof ProcessEventMap>(
          eventName: E,
          ...args: ProcessEventMap[E]
        ): boolean;
        ...
        listeners<E extends keyof ProcessEventMap>(
          eventName: E,
        ): ((...args: ProcessEventMap[E]) => void)[];
        ...
        rawListeners<E extends keyof ProcessEventMap>(
          eventName: E,
        ): ((...args: ProcessEventMap[E]) => void)[];
        rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
        // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
        removeAllListeners<E extends keyof ProcessEventMap>(
          eventName?: E,
        ): this;
