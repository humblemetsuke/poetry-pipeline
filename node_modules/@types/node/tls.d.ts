...
declare module "node:tls" {
  ...
  class TLSSocket extends net.Socket {
    ...
    emit<E extends keyof TLSSocketEventMap>(
      eventName: E,
      ...args: TLSSocketEventMap[E]
    ): boolean;
    ...
    listeners<E extends keyof TLSSocketEventMap>(
      eventName: E,
    ): ((...args: TLSSocketEventMap[E]) => void)[];
    listeners(eventName: string | symbol): ((...args: any[]) => void)[];
    off<E extends keyof TLSSocketEventMap>(
      eventName: E,
      listener: (...args: TLSSocketEventMap[E]) => void,
    ): this;
    off(eventName: string | symbol, listener: (...args: any[]) => void): this;
    on<E extends keyof TLSSocketEventMap>(
      eventName: E,
      listener: (...args: TLSSocketEventMap[E]) => void,
    ): this;
    on(eventName: string | symbol, listener: (...args: any[]) => void): this;
    once<E extends keyof TLSSocketEventMap>(
      eventName: E,
      listener: (...args: TLSSocketEventMap[E]) => void,
    ): this;
    ...
    rawListeners<E extends keyof TLSSocketEventMap>(
      eventName: E,
    ): ((...args: TLSSocketEventMap[E]) => void)[];
  ...
  interface ConnectionOptions
     ...
     */
    pskCallback?:
      | ((hint: string | null) => PSKCallbackNegotation | null)
      | undefined;
  }
  interface ServerEventMap extends net.ServerEventMap {
    ...
    resumeSession: [
      sessionId: Buffer,
      callback: (err: Error | null, sessionData?: Buffer) => void,
    ];
  ...
  function setDefaultCACertificates(
    certs: ReadonlyArray<string | NodeJS.ArrayBufferView>,
  ): void;
  /**
