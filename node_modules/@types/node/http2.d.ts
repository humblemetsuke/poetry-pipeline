...
declare module "node:http2" {
  ...
  interface Http2Stream extends stream.Duplex {
    ...
    emit<E extends keyof Http2StreamEventMap>(
      eventName: E,
      ...args: Http2StreamEventMap[E]
    ): boolean;
    ...
    listeners<E extends keyof Http2StreamEventMap>(
      eventName: E,
    ): ((...args: Http2StreamEventMap[E]) => void)[];
    ...
    rawListeners<E extends keyof Http2StreamEventMap>(
      eventName: E,
    ): ((...args: Http2StreamEventMap[E]) => void)[];
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof Http2StreamEventMap>(
      eventName?: E,
    ): this;
  ...
  interface ClientHttp2Stream extends Http2Stream {
    ...
    emit<E extends keyof ClientHttp2StreamEventMap>(
      eventName: E,
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof ClientHttp2StreamEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  interface ServerHttp2SessionEventMap<
    ...
    Http1Response extends typeof ServerResponse<InstanceType<Http1Request>> =
  ...
  > extends Http2Session {
    ...
    addListener<E extends keyof ServerHttp2SessionEventMap>(
      eventName: E,
      listener: (
        ...args: ServerHttp2SessionEventMap<
          Http1Request,
          Http1Response,
          Http2Request,
          Http2Response
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof ServerHttp2SessionEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  >
    extends
      net.ServerEventMap,
      Pick<Http2SessionEventMap, "stream" | "timeout"> {
    checkContinue: [
  ...
  >
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof Http2ServerEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  >
    ...
    addListener<E extends keyof Http2SecureServerEventMap>(
      eventName: E,
      listener: (
        ...args: Http2SecureServerEventMap<
          Http1Request,
          Http1Response,
          Http2Request,
          Http2Response
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof Http2SecureServerEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
  ...
  class Http2ServerRequest extends stream.Readable {
    ...
    emit<E extends keyof Http2ServerRequestEventMap>(
      eventName: E,
      ...args: Http2ServerRequestEventMap[E]
    ): boolean;
    emit(eventName: string | symbol, ...args: any[]): boolean;
    ...
    rawListeners(eventName: string | symbol): ((...args: any[]) => void)[];
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    removeAllListeners<E extends keyof Http2ServerRequestEventMap>(
      eventName?: E,
    ): this;
    removeAllListeners(eventName?: string | symbol): this;
