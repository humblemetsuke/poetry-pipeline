...
type _Performance = typeof globalThis extends { onmessage: any }
  ? {}
  : perf_hooks.Performance;
type _PerformanceEntry = typeof globalThis extends { onmessage: any }
  ? {}
  : perf_hooks.PerformanceEntry;
type _PerformanceMark = typeof globalThis extends { onmessage: any }
  ? {}
  : perf_hooks.PerformanceMark;
type _PerformanceMeasure = typeof globalThis extends { onmessage: any }
  ? {}
  : perf_hooks.PerformanceMeasure;
type _PerformanceObserver = typeof globalThis extends { onmessage: any }
  ? {}
  : perf_hooks.PerformanceObserver;
type _PerformanceObserverEntryList = typeof globalThis extends {
  onmessage: any;
}
  ? {}
...
declare global {
  ...
  var PerformanceObserverEntryList: typeof globalThis extends {
    ...
    ? T
    : typeof perf_hooks.PerformanceObserverEntryList;
