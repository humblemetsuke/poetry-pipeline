...
declare module "node:worker_threads" {
  ...
  interface WorkerPerformance extends Pick<
    Performance,
  ...
  interface BroadcastChannel
    extends
      EventTarget,
      InternalEventTargetEventProperties<BroadcastChannelEventMap>,
      NodeJS.RefCounted {
  ...
  interface MessagePort
    extends
      NodeEventTarget,
      InternalEventTargetEventProperties<MessagePortEventMap> {
    close(): void;
