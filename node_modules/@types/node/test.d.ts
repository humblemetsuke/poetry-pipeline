...
declare module "node:test" {
  ...
  namespace test {
    ...
    interface TestsStream extends Readable {
      ...
      emit<E extends keyof TestsStreamEventMap>(
        eventName: E,
        ...args: TestsStreamEventMap[E]
      ): boolean;
      ...
      listeners<E extends keyof TestsStreamEventMap>(
        eventName: E,
      ...
      removeAllListeners<E extends keyof TestsStreamEventMap>(
        eventName?: E,
      ): this;
    ...
    interface TestContextAssert extends Pick<
    ...
    interface MockTracker {
      ...
      >(
        ...
        mock: MockPropertyContext<MockedObject[PropertyName]>;
      };
      /**
